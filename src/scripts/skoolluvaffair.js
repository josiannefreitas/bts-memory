const main = document.getElementById('skoolluvaffair-main')
...
function renderizarCartas() {
  ...
  for (let i = 0; i < photosEmbaralhadas.length; i++) {
    ...
    carta.src = '../../assets/skoolluvaffair.jpg'
...
function tesstPar() {
  if (click01.id == click02.id) {
    ...
    setTimeout(() => {
      click01.src = '../../assets/skoolluvaffair.jpg'
      click02.src = '../../assets/skoolluvaffair.jpg'
