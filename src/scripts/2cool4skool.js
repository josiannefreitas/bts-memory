const main = document.getElementById('2cool4skool-main')
...
function renderizarCartas() {
  ...
  for (let i = 0; i < photosEmbaralhadas.length; i++) {
    ...
    carta.src = '../../assets/2cool4skool.jpg'
...
function tesstPar() {
  if (click01.id == click02.id) {
    ...
    setTimeout(() => {
      click01.src = '../../assets/2cool4skool.jpg'
      click02.src = '../../assets/2cool4skool.jpg'
