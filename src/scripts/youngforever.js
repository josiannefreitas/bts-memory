const main = document.getElementById('youngforever-main')
...
function renderizarCartas() {
  ...
  for (let i = 0; i < photosEmbaralhadas.length; i++) {
    ...
    carta.src = '../../assets/youngforever.jpg'
...
function tesstPar() {
  if (click01.id == click02.id) {
    ...
    setTimeout(() => {
      click01.src = '../../assets/youngforever.jpg'
      click02.src = '../../assets/youngforever.jpg'
